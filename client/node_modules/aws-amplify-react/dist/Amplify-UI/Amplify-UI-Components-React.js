...
exports.NavButton = function (props) {
    ...
    var p = core_1.JS.objectLessAttributes(props, 'theme');
    return exports.beforeAfter(React.createElement("button", __assign({}, p, { className: AmplifyUI.button, style: theme.toast }), exports.beforeAfter(React.createElement("span", null, props.children))));
};
