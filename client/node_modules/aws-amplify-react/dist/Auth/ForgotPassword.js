...
var ForgotPassword = /** @class */ (function (_super) {
    ...
    ForgotPassword.prototype.submit = function () {
        var _this = this;
        var _a = this.inputs, username = _a.username, code = _a.code, password = _a.password;
    ...
    ForgotPassword.prototype.showComponent = function (theme) {
        var _this = this;
        var _a = this.props, authState = _a.authState, hide = _a.hide;
        ...
        return (React.createElement(Amplify_UI_Components_React_1.FormSection, { theme: theme },
            ...
            React.createElement(Amplify_UI_Components_React_1.SectionBody, null, this.state.delivery ? this.submitView() : this.sendView()),
            React.createElement(Amplify_UI_Components_React_1.SectionFooter, { theme: theme },
                React.createElement(Amplify_UI_Components_React_1.SectionFooterPrimaryContent, { theme: theme }, this.state.delivery ?
                ...
                React.createElement(Amplify_UI_Components_React_1.SectionFooterSecondaryContent, { theme: theme }, this.state.delivery ?
