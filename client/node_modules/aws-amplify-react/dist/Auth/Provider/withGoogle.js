...
function withGoogle(Comp) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.signIn = function () {
            ...
            ga.signIn().then(function (googleUser) { return _this.federatedSignIn(googleUser); }, function (error) {
                if (onError)
                    onError(error);
                else
                    throw error;
        ...
        class_1.prototype.render = function () {
            var ga = window.gapi && window.gapi.auth2
                ...
                : null;
            return React.createElement(Comp, __assign({}, this.props, { ga: ga, googleSignIn: this.signIn }));
        };
        return class_1;
    }(react_1.Component));
}
