...
import myReviewEdit from '../../myReviews/components/Review/myReviewsEdit'
  ...
  render() {
    ...
    return (
      <Switch>
        ...
        <Route path="/:language/myReviews" component={myReviews} />
        <Route path="/:language/myReviewEdit" component={myReviewEdit} />
