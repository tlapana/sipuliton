...
exports.lambdaHandler = async (event, context) => {
    try {
        ...
        const resRestaurant = await client.query(collectRestaurantPage, [testRestaurant]);
        var jsonString = JSON.stringify(resRestaurant.rows);
        var jsonObjRestaurant = JSON.parse(jsonString);


        const resReviews = await client.query(collectReviews, [testRestaurant, pageSize, offset]);
